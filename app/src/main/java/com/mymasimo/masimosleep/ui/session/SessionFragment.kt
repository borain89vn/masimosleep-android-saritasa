...
class SessionFragment : Fragment(R.layout.fragment_session) {
    ...
    private fun showNoDataConfiguration() {
        ...
        addFragment(createSessionExportMeasurementsFragment(), EXPORT_MEASUREMENTS_FRAGMENT_TAG)
    }
     ...
     */
    private fun createSessionExportMeasurementsFragment(): SessionExportMeasurementsFragment {
        return SessionExportMeasurementsFragment.newInstance().apply {
            setOnClickListener {
