package com.mymasimo.masimosleep.ui.session.session_event_detail
...
import com.mymasimo.masimosleep.ui.night_report.report_events.details.EventDetailsAdapter
import com.mymasimo.masimosleep.ui.night_report.report_events.details.EventDetailsViewModel
import javax.inject.Inject

class SessionEventDetailsFragment : Fragment(R.layout.fragment_event_details) {

    @Inject
    lateinit var vmFactory: ViewModelProvider.Factory
    private val vm: EventDetailsViewModel by viewModels { vmFactory }
    private val args: SessionEventDetailsFragmentArgs by navArgs()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        vm.onCreatedWithStartAt(args.sessionStart)
    }
